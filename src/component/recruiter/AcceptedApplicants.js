...
const useStyles = makeStyles((theme) => ({
  body: {
    ...
    backgroundImage: `url('https://images.pexels.com/photos/1103970/pexels-photo-1103970.jpeg?cs=srgb&dl=pexels-johannes-plenio-1103970.jpg&fm=jpg')`,  // Replace with the path to your image
...
const AcceptedApplicants = (props) => {
  ...
  return (
    <div className={classes.body}>
      ...
      >
        <Grid item>
        <Typography variant="h2" style={{ fontFamily: "Palatino", color: "White", fontWeight: "bold", textShadow: "2px 2px 4px rgba(0,0,0,0.7)", fontSize: "5rem" }}>
  My Employees
</Typography>
        </Grid>
        <Grid item>
